...
MAILGUN_DOMAIN = os.environ.get("MAILGUN_DOMAIN_K")
MAILGUN_API_KEY = os.environ.get("MAILGUN_API_KEY_K")
FROM_TITLE = os.environ.get("FROM_TITLE_K")
FROM_EMAIL = os.environ.get("FROM_EMAIL_K")
